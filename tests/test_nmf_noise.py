...
noise_test_path = 'brahms_restore_ml/nmf/output/output_test/output_test_noise_learnpiano/'
noise_learnnoise_test_path = 'brahms_restore_ml/nmf/output/output_test/output_test_noise_learnnoise/'
...
class RestoreNoiseTests(unittest.TestCase):
    ...
    def test_bv_sound(self):
        ...
        out_filepath = test_path + 'NoiseBasisVectors' + str(num_noise) + '.wav'
