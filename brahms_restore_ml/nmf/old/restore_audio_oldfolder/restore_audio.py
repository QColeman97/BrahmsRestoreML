...
# # V LOGIC
# # Compared to new - missing epsilon & hop_size_divisor & sgmt_len & transpose remove
...
# # Compared to new - missing rm return_16bit & hop_size_div & dealing w/ not transposed input spgm
...
# Compared to new - missing a transpose in the beginning
...
# Compared to new - missing removal of uneccesarystuff
