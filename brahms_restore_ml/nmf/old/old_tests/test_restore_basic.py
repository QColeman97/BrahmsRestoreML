...
class BasicRestoreTests(unittest.TestCase):
    ...
    def test_restore_brahms_ova(self):
        ...
        sr, sig = wavfile.read(brahms_filepath)
        synthetic_sig = nmf.restore_audio(sig, nmf.PIANO_WDW_SIZE, out_filepath, sr, ova=True,
                                      write_file=write_flag, debug=debug_flag)
    ...
    def test_restore_brahms_avgbv(self):
        ...
        sr, sig = wavfile.read(brahms_filepath)
        synthetic_sig = nmf.restore_audio(sig, nmf.PIANO_WDW_SIZE, out_filepath, sr, avgbv=True,
                                      write_file=write_flag, debug=debug_flag)
    ...
    def test_restore_brahms_noisebv(self):
        ...
        sr, sig = wavfile.read(brahms_filepath)
        synthetic_sig = nmf.restore_audio(sig, nmf.PIANO_WDW_SIZE, out_filepath, sr, noisebv=True, 
